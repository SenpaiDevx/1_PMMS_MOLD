...
try {
    ...
    $insert_query = "INSERT INTO pms_scaninout (
        ...
        TIME_OUT, STATUS, MOLD_CONDITION, REMARKS, 
        PMS_RUNTIME
    ) VALUES (
        :PMS_CONTROL_NO, :PROCESS_NAME, :PROCESS_CODE, 
        :TIME_OUT, :STATUS, :MOLD_CONDITION, :REMARKS, :PMS_RUNTIME
    )";
    $loca_time = convertMilitaryTo12HourTime($_POST['pms']['TIME_OUT'], "Asia/Manila");
